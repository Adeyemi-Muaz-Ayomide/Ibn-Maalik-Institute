...
import { BookOpen, Mail, Phone, MapPin, MessageCircle, Clock } from 'lucide-react';
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                <MessageCircle className="w-5 h-5 text-green-400 mt-1 mr-3 flex-shrink-0" />
                <div>
                  <h4 className="font-semibold text-white mb-1">WhatsApp (Preferred)</h4>
                  <p className="text-gray-300 text-sm mb-2">Get instant responses and personalized guidance</p>
                  <a
                    href="https://wa.me/1234567890?text=Hi, I'm interested in joining Ibn Maalik Institute!"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center bg-green-600 text-white px-4 py-2 rounded-full hover:bg-green-700 transition-colors text-sm font-semibold"
                  >
              ...
              <div className="flex items-start">
                <Mail className="w-5 h-5 text-emerald-400 mt-1 mr-3 flex-shrink-0" />
                <div>
                  <h4 className="font-semibold text-white mb-1">Email</h4>
                  <p className="text-gray-300 text-sm mb-1">For detailed inquiries and enrollment</p>
                  <a href="mailto:info@ibnmaalikinstitute.com" className="text-emerald-400 hover:text-emerald-300 text-sm">
              ...
              <div className="flex items-start">
                <Phone className="w-5 h-5 text-emerald-400 mt-1 mr-3 flex-shrink-0" />
                <div>
                  <h4 className="font-semibold text-white mb-1">Phone</h4>
                  <p className="text-gray-300 text-sm mb-1">International support available</p>
              ...
              <div className="flex items-start">
                <Clock className="w-5 h-5 text-emerald-400 mt-1 mr-3 flex-shrink-0" />
                <div>
                  <h4 className="font-semibold text-white mb-1">Response Times</h4>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col lg:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm mb-4 lg:mb-0">
              © {new Date().getFullYear()} Ibn Maalik Institute. All rights reserved. | Privacy Policy | Terms of Service
            </div>
