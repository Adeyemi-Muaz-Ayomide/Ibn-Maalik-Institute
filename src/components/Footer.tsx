        ...
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex space-x-4">
              <a href="#" className="bg-emerald-600 text-white p-2 rounded-full hover:bg-emerald-700 transition-colors">
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  <p className="text-gray-300">info@tarteelacademy.com</p>
                  <p className="text-gray-400 text-sm">24h response time</p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">9 AM - 6 PM EST</p>
                </div>
              </div>
              <div className="flex items-start">
                <MapPin className="w-5 h-5 text-emerald-400 mt-1 mr-3 flex-shrink-0" />
                <div>
                  <p className="text-gray-300">Global Online Academy</p>
                  <p className="text-gray-400 text-sm">Serving 50+ countries</p>
                </div>
              </div>
              <a
                ...
                className="inline-flex items-center bg-green-600 text-white px-4 py-2 rounded-full hover:bg-green-700 transition-colors font-semibold text-sm mt-4"
              >
