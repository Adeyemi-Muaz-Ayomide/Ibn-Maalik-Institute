      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Ready to start your Arabic learning journey? We're here to help you every step of the way.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg">
            ...
            <form className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-emerald-600 text-white px-8 py-4 rounded-lg hover:bg-emerald-700 transition-colors font-semibold flex items-center justify-center"
              >
            ...
            <p className="text-center text-gray-500 text-sm mt-4">
              For faster response, we recommend contacting us via WhatsApp
            </p>
          </div>
        </div>
      </div>
